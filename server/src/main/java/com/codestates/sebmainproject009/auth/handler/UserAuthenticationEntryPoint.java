...
public class UserAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    SecurityContext 에 Authentication 이 저장되지 않을 경우 등 AuthenticationException 이 발생할 때 호출되는 핸들러 같은 역할을 합니다.

    UserAuthenticationEntryPoint 클래스는 인증 과정에서 AuthenticationException 이 발생할 경우 호출
     */
    @Override
